...
from codeLibraries.saveAsCSV import saveAsCSV
from codeLibraries.readCSV import readCSV
from codeLibraries.getGPTResponse import getOneLine
from codeLibraries.emailAlerts import sendEmail
from codeLibraries.Triage import triage
from codeLibraries.Airtable import uploadToAirtable
...
def getIntros(driver, followers):
    ...
    filename = "./data/outreachList.csv"
        ...
        if account[1] != "done":
            ...
            try:
                ...
                if passed:
                    ...
                    uploadToAirtable(item)

                else:

                    # if not found, create failed list, if found append
                    failedList = []

                    try: 
                        failedList = readCSV("./data/failedTriage.csv")
                        
                        failedList.append([account[0], userDescription])

                        saveAsCSV(failedList,"./data/failedTriage.csv")
